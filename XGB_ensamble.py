...
preprocessor = ColumnTransformer(
    transformers=[
        ('num', Pipeline(steps=[('imputer', SimpleImputer(strategy='median')), ('scaler', StandardScaler())]), features),
...
ensemble_clf = VotingClassifier(estimators=[
    ...
    ('xgb', XGBClassifier(n_estimators=100, max_depth=3, subsample=0.75, verbosity=1, use_label_encoder=False, eval_metric='logloss'))
], voting='soft')
