...
from sklearn.experimental import enable_hist_gradient_boosting  # not needed for sklearn>=1.0
from sklearn.ensemble import HistGradientBoostingClassifier
from sklearn.impute import SimpleImputer
import matplotlib.pyplot as plt
from joblib import Memory

# Инициализация объекта Memory для кэширования
...
num_preprocessor = Pipeline(steps=[('imputer', SimpleImputer(strategy='median')), ('scaler', StandardScaler())], memory=memory)
cat_preprocessor = Pipeline(steps=[('imputer', SimpleImputer(strategy='most_frequent')), ('encoder', OneHotEncoder(handle_unknown='ignore'))], memory=memory)
...
model = Pipeline([
    ...
    ('classifier', HistGradientBoostingClassifier(max_iter=100, random_state=42, learning_rate=0.1))
])
...
print("HistGradientBoosting Classifier Report:")
...
# Подготовка данных для тестового набора и создание файла сабмиссии
